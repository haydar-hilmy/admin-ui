...
function AuthLayout(props) {
  ...
  const { isDarkMode, setIsDarkMode, bgMode, txtMode } = useContext(ThemeContext)
  console.group("AuthLayout")
  console.log("isDarkMode: ", isDarkMode)
  console.groupEnd()

  return (
    <div className={`flex justify-center min-h-screen items-center bg-main-bg ${bgMode} bg-special-mainBg`}>
      {
        isLoading && (
